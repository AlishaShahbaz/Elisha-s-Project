...
export default function FAQAccordion() {
  const faqs = [
    {
      question: "What is Goziply?",
      answer:
        "Goziply is a platform that connects people with local freelancers to help with everyday tasks like cleaning, moving, delivery, and handyman services.",
    },
    {
